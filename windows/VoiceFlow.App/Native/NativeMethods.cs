...
/// <summary>Raw P/Invoke declarations for the Win32 hotkey and input-injection APIs. No behavior here — see <see cref="VoiceFlow.App.GlobalHotkey"/> and <see cref="VoiceFlow.App.SendInputTextInjector"/>.</summary>
